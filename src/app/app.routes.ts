...
export const routes: Routes = [
    ...
    { path: 'dashboard', component: DashboardComponent, 
        canActivate: [AuthGuardsService], data: { role: ['RI', 'AO', 'SECRETARY', 'COMMISSIONER','USER','ADMIN','IT-TEAM','CO_ADMIN','CAOCC'] } },
    { path: 'assets', component: AssetsComponent, 
        canActivate: [AuthGuardsService], data: { role: ['RI', 'AO', 'SECRETARY', 'COMMISSIONER','ADMIN','IT-TEAM','CO_ADMIN','CAOCC'] } },
    { path: 'user', component: UserDetailsComponent,
        canActivate: [AuthGuardsService], data: { role: ['RI', 'AO', 'SECRETARY', 'COMMISSIONER','ADMIN','IT-TEAM','CO_ADMIN','CAOCC'] } },
    { path: 'userTagging', component: UserTaggingsComponent,
         canActivate: [AuthGuardsService], data: { role: ['AO', 'SECRETARY', 'COMMISSIONER','RI','ADMIN','IT-TEAM','CO_ADMIN','CAOCC'] } },
    { path: 'billDetails', component: BillDetailsComponent,
         canActivate: [AuthGuardsService], data: { role: ['RI', 'AO','USER','ADMIN','IT-TEAM','CO_ADMIN','CAOCC'] } },
    { path: 'receptDetails', component: ReceiptDetailsComponent, 
        canActivate: [AuthGuardsService], data: { role: ['RI', 'AO','USER','ADMIN','IT-TEAM','CO_ADMIN','CAOCC'] } },
    { path: 'transactionTracking', component: TransactionTrackingComponent, 
        canActivate: [AuthGuardsService], data: { role: ['RI', 'AO','ADMIN','IT-TEAM','CO_ADMIN','CAOCC'] } },
    { path: 'changeRequest', component: ChangeRequestComponent, 
        canActivate: [AuthGuardsService], data: { role: ['RI','AO', 'SECRETARY', 'COMMISSIONER','ADMIN','USER','IT-TEAM','CO_ADMIN','CAOCC'] } },
    ...
    { path: 'vacant-properties', component: VacantPropertiesComponent, canActivate: [AuthGuardsService], data: { role: ['RI','AO', 'SECRETARY', 'COMMISSIONER','ADMIN','USER','IT-TEAM','CO_ADMIN','CAOCC'] } },
    { path: 'issueNotice', component: IssueNoticeComponent, canActivate: [AuthGuardsService], data: { role: ['RI','AO','ADMIN','IT-TEAM','CO_ADMIN','CAOCC'] } },
