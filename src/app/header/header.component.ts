    ...
    if (this.passwordform.valid) {
      ...
      if (old_password !== null) {
        if (new_password === confirm_new_password && new_password !== old_password) {
          const old_encryptedPassword = this.authService.encryptPassword(old_password);
          const new_encryptedPassword = this.authService.encryptPassword(new_password);
          const senddata = {
            old_encryptedPassword,
            new_encryptedPassword,
